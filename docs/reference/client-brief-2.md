...
Her har jeg bare sortert mailer etter dato. Ingen gruppering etter emner.

[1210_Linstow_Kronprinsensgate 9](https://www.notion.so/1210_Linstow_Kronprinsensgate-9-30b57c8ba80e8056aad9fd28f612bc1e?pvs=21)

![image.png](attachment:3eebcd06-1fed-4138-a3b9-9e2ebb65925d:image.png)

### Clean emne navn

Jeg grupperer mailene etter emne taggen. Men det hadde vært nice om jeg kunne gruppere de etter emne navn isteden. Da ville emne stått over gruppen der ID-en står nå.
Men dette er ikke mulig siden Emnenavnet endrer seg når noen svarer eller videresender mailene. Er det mulig å cleane opp slik at alle mailer innenfor en mail tråd kommer inn med et cleanet emnenavn?

![image.png](attachment:abd565bf-10ec-4e49-bf22-d52746ef3af7:image.png)
...
# Brukerstyring integrasjon

### Kort forklaring

Vi har brukere på så mange steder. Og vi betaler ofte lisens pr bruker. Hadde vært nice med en funksjon der jeg kan melde inn eller melde ut brukere fra mange platformer på en gang
